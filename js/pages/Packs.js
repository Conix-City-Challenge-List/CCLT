        ...
        <main v-else class="page-list">
            ...
            <div class="level-container">
                ...
                <div class="copy-container">
                    ...
                    <h2>Difficulty: {{ ["EASY", "MEDIUM", "HARD", "EXTREME", "IMPOSSIBLE", "SILENT"][selectedPack.difficulty] }}</h2>
                    ...
                    <p v-if="selectedPack.levels" class="type-body">
                        <template v-for="(level, index) in selectedPack.levels">
                            <a class="director" :href="'https://cclt.pages.dev/#/level/' + level.path">{{ level.name }}</a>
                    ...
                    <div class="pack-records">
                        <p v-for="record in selectedPack.records">
                            <a class="director" :href="'https://cclt.pages.dev/#/leaderboard/user/' + record.toLowerCase().replaceAll(' ', '_')">{{ record }}</a>
                        </p>
                    </div>
                </div>
                <!-- whatever this is -->
